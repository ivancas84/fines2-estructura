...
class ComisionCrearCursosApi extends PersistApi {
  /**
  ...
  public function main(){
    ...
    foreach($cargasHorarias as $ch){
      ...
      $curso->_set("horas_catedra", $ch["horas_catedra.sum"]);
      ...
      $sql .= $this->container->persist("curso")->insert($curso->_toArray("sql"));
