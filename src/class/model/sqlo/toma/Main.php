...
class TomaSqloMain extends EntitySqlo {
  ...
  public function __construct(){
    ...
    $this->sql = EntitySql::getInstanceFromString('toma');
  }
...
";
  ...
  public function json(array $row){
    ...
    if(!is_null($row['ree_id'])){
      $json = EntitySql::getInstanceFromString('id_persona', 'ree')->_json($row);
  ...
  public function values(array $row){
    ...
    $json = ($row && !is_null($row['ree_id'])) ? EntitySql::getInstanceFromString('id_persona', 'ree')->_json($row) : null;
