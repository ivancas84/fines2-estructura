...
";
  ...
  public function values(array $row){
    ...
    $row_["clasificacion_plan"] = EntityValues::getInstanceRequire("clasificacion_plan", $row);
    $row_["clasificacion"] = EntityValues::getInstanceRequire('clasificacion', $row, 'cla_');
