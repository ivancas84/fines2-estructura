...
class CoordinadorSqloMain extends EntitySqlo {
  ...
  public function __construct(){
    ...
    $this->sql = EntitySql::getInstanceFromString('coordinador');
  }
...
";
  ...
  public function values(array $row){
    ...
    $row_["coordinador"] = EntityValues::getInstanceFromString("coordinador", $json);
    ...
    $row_["coordinador1"] = EntityValues::getInstanceFromString('id_persona', $json);
