...
class _Permiso extends EntityValues {
  ...
  public function _isEmpty(){
    ...
    if(!Validation::is_empty($this->rol)) return false;
  ...
  public function checkRol($value) { 
    $v = Validation::getInstanceValue($value)->integer()->required();
    return $this->_setLogsValidation("rol", $v);
  }
