...
class _HorarioSql extends EntitySql{
  ...
  public function mappingField($field){
    ...
    if($f = $this->container->getSql('dia', 'dia')->_mappingField($field)) return $f;
...
' . $this->container->getSql('dia', 'dia')->_fields() . ' 
';
  }
...
' ;
  ...
  protected function conditionFieldStruct($field, $option, $value) {
    ...
    if($c = $this->container->getSql('dia','dia')->_conditionFieldStruct($field, $option, $value)) return $c;
  }
  ...
  protected function conditionFieldAux($field, $option, $value) {
    ...
    if($c = $this->container->getSql('dia','dia')->_conditionFieldAux($field, $option, $value)) return $c;
  }
