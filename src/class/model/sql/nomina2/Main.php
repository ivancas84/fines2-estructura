...
class Nomina2SqlMain extends EntitySql{
  ...
  public function _fields(){
    ...
    $p = $this->prf();
    return '
' . $this->_mappingField($p.'id') . ' AS ' . $p.'id, ' . $this->_mappingField($p.'fotocopia_documento') . ' AS ' . $p.'fotocopia_documento, ' . $this->_mappingField($p.'partida_nacimiento') . ' AS ' . $p.'partida_nacimiento, ' . $this->_mappingField($p.'alta') . ' AS ' . $p.'alta, ' . $this->_mappingField($p.'constancia_cuil') . ' AS ' . $p.'constancia_cuil, ' . $this->_mappingField($p.'certificado_estudios') . ' AS ' . $p.'certificado_estudios, ' . $this->_mappingField($p.'anio_ingreso') . ' AS ' . $p.'anio_ingreso, ' . $this->_mappingField($p.'activo') . ' AS ' . $p.'activo, ' . $this->_mappingField($p.'programa') . ' AS ' . $p.'programa, ' . $this->_mappingField($p.'observaciones') . ' AS ' . $p.'observaciones, ' . $this->_mappingField($p.'persona') . ' AS ' . $p.'persona, ' . $this->_mappingField($p.'comision') . ' AS ' . $p.'comision';
  }
  ...
  public function _fieldsDb(){
    ...
    $p = $this->prf();
    return '
' . $this->_mappingField($p.'id') . ', ' . $this->_mappingField($p.'fotocopia_documento') . ', ' . $this->_mappingField($p.'partida_nacimiento') . ', ' . $this->_mappingField($p.'alta') . ', ' . $this->_mappingField($p.'constancia_cuil') . ', ' . $this->_mappingField($p.'certificado_estudios') . ', ' . $this->_mappingField($p.'anio_ingreso') . ', ' . $this->_mappingField($p.'activo') . ', ' . $this->_mappingField($p.'programa') . ', ' . $this->_mappingField($p.'observaciones') . ', ' . $this->_mappingField($p.'persona') . ', ' . $this->_mappingField($p.'comision') . '';
  }
