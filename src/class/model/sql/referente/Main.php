...
class ReferenteSqlMain extends EntitySql{
  ...
  public function _fields(){
    ...
    $p = $this->prf();
    return '
' . $this->_mappingField($p.'id') . ' AS ' . $p.'id, ' . $this->_mappingField($p.'alta') . ' AS ' . $p.'alta, ' . $this->_mappingField($p.'baja') . ' AS ' . $p.'baja, ' . $this->_mappingField($p.'persona') . ' AS ' . $p.'persona, ' . $this->_mappingField($p.'sede') . ' AS ' . $p.'sede';
  }
  ...
  public function _fieldsDb(){
    ...
    $p = $this->prf();
    return '
' . $this->_mappingField($p.'id') . ', ' . $this->_mappingField($p.'alta') . ', ' . $this->_mappingField($p.'baja') . ', ' . $this->_mappingField($p.'persona') . ', ' . $this->_mappingField($p.'sede') . '';
  }
