...
class TomaSqlMain extends EntitySql{
  ...
  public function mappingField($field){
    ...
    if($f = EntitySql::getInstanceRequire('modalidad', 'cur_com_mod')->_mappingField($field)) return $f;
...
' . EntitySql::getInstanceRequire('modalidad', 'cur_com_mod')->_fields() . ',
...
' . EntitySql::getInstanceRequire('modalidad', 'cur_com_mod')->_join('modalidad', 'cur_com', $render) . '
...
' ;
  ...
  protected function conditionFieldStruct($field, $option, $value) {
    ...
    if($c = EntitySql::getInstanceRequire('modalidad','cur_com_mod')->_conditionFieldStruct($field, $option, $value)) return $c;
  ...
  protected function conditionFieldAux($field, $option, $value) {
    ...
    if($c = EntitySql::getInstanceRequire('modalidad','cur_com_mod')->_conditionFieldAux($field, $option, $value)) return $c;
  ...
  protected function conditionFieldHaving($field, $option, $value) {
    ...
    if($c = EntitySql::getInstanceRequire('modalidad','cur_com_mod')->_conditionFieldHaving($field, $option, $value)) return $c;
