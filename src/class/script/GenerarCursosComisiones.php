...
$import = $container->getController("cursos_comisiones_grupo_persist");
$import->main(["cal-anio"=>'2022',"cal-semestre"=>1,"modalidad"=>"1"]);
...
class GenerarHorariosComisionesSiguientesScript extends BaseController{
  /**
   ...
   public function main(){
     ...
     $grupo = ["cal-anio"=>'2022',"cal-semestre"=>1,"modalidad"=>"1"];
   ...
   protected function definirCursos(){
     $controller = $this->container->getController("cursos_comision_persist_sql");
     $ids = [];
     $detail = [];
